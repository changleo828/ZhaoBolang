...
extern unsigned char const bmpflag1[];
extern unsigned char const bmpflag2[];
extern unsigned char const bmpflag3[];
extern unsigned char const bmpflag4[];
extern unsigned char const bmpflag5[];
